...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'PokeWoke',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color(0xFFb4e600)),
        useMaterial3: true,
      ),
...
class _WebViewScreenState extends State<WebViewScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('PokeWoke'),
        backgroundColor: Color(0xFFb4e600),
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: isUser ? Color(0xFFb4e600) : Colors.grey[200],
